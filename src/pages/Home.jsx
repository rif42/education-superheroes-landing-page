        ...
        <div className='w-[99%] h-fit Home'>
            <div className=' h-[70vw] flex flex-row justify-center bg-home0 bg-no-repeat bg-center bg-cover'>
                <div className='w-[50%] h-full flex flex-col justify-center align-middle text-left pl-[15vw]'>
                    ...
                    <h2 className='text-[2vw] font-medium italic text-white'>The Trigger of Life Company!</h2>
                    <p className='text-[1.5vw] text-white pt-[2vw] leading-relaxed'>
                        <b>YOU WANT CHANGE</b> Excitement, Love, Curiosity, Perseverance, Goals, Success, Courage, Will,
                        Leadership, Team, Culture, Happiness, Strength, Knowledge, Experience, and LIFE! Is this not
                        what <b>LEARNING</b>
            ...
            <div className=' h-[40vw] flex flex-row justify-center'>
                <div className='w-[50%] h-full flex flex-col justify-center align-middle text-center'>
                    <img className='ml-[12vw] w-[30vw]' src={"/src/assets/pic-home-1.jpg"} alt={"picture of ira"} />
                </div>
                <div className='w-[50%] h-full flex flex-col justify-center align-middle pr-[15vw]'>
                    ...
                    <p className='text-[1.2vw] pt-[1vw] leading-relaxed text-[#6A6D9E] text-left pr-[10vw]'>
                        We want the best for our students and teachers. Somehow, we get stuck, unable to move forward
                        because we didn’t see the pitfalls and don’t know how to move forward. Call Us! We can Help!
                    </p>
                </div>
            </div>
            ...
            <div className=' h-[40vw] flex flex-row justify-center'>
                <div className='w-[50%] h-full flex flex-col justify-center align-middle text-center pl-[10vw]'>
                    ...
                    <p className='text-[1.2vw] pt-[1vw] leading-relaxed text-[#6A6D9E] text-left pr-[12vw]'>
                        The skill to learn is to do more, with less. Maintain the highest quality of learning while
            ...
            <div className=' h-[40vw] flex flex-row justify-center'>
                ...
                <div className='w-[50%] h-full flex flex-col justify-center align-middle pr-[15vw]'>
                    ...
                    <p className='text-[1.2vw] pt-[1vw] leading-relaxed text-[#6A6D9E] text-left pr-[10vw]'>
                        What our young students need from us is for us to live our best life! To be the best version of
            ...
            <div className=' h-[60vw] flex flex-col justify-center py-[3vw]'>
                ...
                <p className='text-[1.5vw] text-black pt-[3vw] px-[15vw] text-center pb-[3vw]'>
                    In the buzz and busyness of curriculum, homework, tests, exams, quizzes, grading, administrative
                    work and reporting, we have forgotten ourselves, our purpose and our happiness. Some may agree and
                    more will disagree. It’s ok! Let’s just look into the mirror and be brutally honest.
                </p>
                <div className='h-[40vw] flex flex-col justify-center bg-home1 bg-center bg-no-repeat bg-contain'>
                    <p className='text-white text-[3vw] font-semibold text-center px-[17vw]'>
                        When you make the decision that your happiness is key to you being the best educator, come join
                        the party!
                    </p>
                </div>
            </div>
            ...
            <div className=' h-[35vw] flex flex-col justify-center bg-no-repeat bg-cover bg-home2 '>
                <p className='text-[1.5vw] text-black text-center pb-[1vw]'>
                    You live in a world where education can be really amazing and relevant. You don’t have to learn many
                    new things.
                </p>
