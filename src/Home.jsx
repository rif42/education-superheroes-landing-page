...
function Home() {
  return (
    <div className="w-full h-fit Home">
      <div className="w-full h-[70vw] flex flex-row justify-center bg-home0 bg-no-repeat bg-center bg-cover">
      ...
      <div className="w-full h-[40vw] flex flex-row justify-center">
        <div className="w-[50%] h-full flex flex-col justify-center align-middle text-center">
          <img
      ...
      <div className="w-full h-[60vw] flex flex-col justify-center pt-[3vw]">
        ...
        <div className="h-[40vw] flex flex-col justify-center bg-home1 bg-center bg-no-repeat bg-contain">
          ...
          When you make the decision that your happiness is key to you being the best educator, come join the party!
          </p>
        </div>
      </div>
    </div>
